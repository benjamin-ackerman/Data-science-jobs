...
I used code from [this repository](https://github.com/lmullen/mullenMisc/blob/master/R/jitter-latlong.R) to jitter the latitude and longitude so that multiple points per city could be seen.
...
- Reproducibility issue: data are unique to when they are scraped
