...
In order to assess any differences in jobs by location, proportions of jobs that offer visa sponsorship, allow remote work, and assist with relocation were compared between jobs listed in the US and Europe, the two geographic regions with the highest numbers of job listings, using two-sample t-tests [@citeR].  The distributions of highest degree preferred were compared across regions with a Pearson's Chi-squared test.
...
*Discussion: mention Stack Overflow blog posts about the rise of Python and R, rise in Europe's startup culture*

- [Rise of Python](https://stackoverflow.blog/2017/09/06/incredible-growth-python/)
- [Rise of R](https://stackoverflow.blog/2017/10/10/impressive-growth-r/)
- [Berlin's startup culture](http://www.computerweekly.com/feature/Berlin-and-the-European-startup-race-for-innovation)
- [Eastern Europe startup culture](http://www.independent.co.uk/Business/indyventure/eastern-europe-tech-secotr-entrepreneurs-startup-global-investors-funds-growth-a7752546.html)
