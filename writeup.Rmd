...
# Print the table
kable(diff_tab, format = "latex", booktabs = T) %>%
kable_styling() %>% add_footnote(paste0("Due to missingness, percents are calculated from totals of ",missing[1]," for USA and ",missing[2]," for Europe."), notation = "number")
